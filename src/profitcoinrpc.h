...
#ifndef _PROFITCOINRPC_H_
#define _PROFITCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Profitcoin is not connected
...
/**
 * Profitcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
