#ifndef PROFITCOINGUI_H
#define PROFITCOINGUI_H
...
/**
  Profitcoin GUI main class. This class represents the main window of the Profitcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ProfitcoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit ProfitcoinGUI(QWidget *parent = 0);
    ~ProfitcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a profitcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
