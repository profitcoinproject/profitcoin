...
public:
	 ...
	 * (e.g from the most recent Profitcoin block) containing the public part
	 ...
	 * @param m arbitrary meta data related to the spend that might be needed by Profitcoin
