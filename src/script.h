...
#ifndef H_PROFITCOIN_SCRIPT
#define H_PROFITCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CProfitcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Profitcoin always counted CHECKMULTISIGs
